...
const ImageUploader = () => {
  ...
  return (
    <div className="image-uploader-container">
      <h1 className="image-uploader-heading">Uvezite sliku koju treba analizirati</h1>
      <form className="image-uploader-form" onSubmit={handleSubmit}>
        ...
        />
        {loading ? <Loader /> : <button type="submit" className="image-uploader-button" disabled={loading}>
